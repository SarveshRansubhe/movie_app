...
class Validators {
  ...
  static bool _validateName(String name) {
    RegExp nameExp = RegExp(r"^[a-zA-Zà-úÀ-Ú']+(?: [a-zA-Zà-úÀ-Ú']+)*$");
    return nameExp.hasMatch(name);
  }

  //A function that validates name  and returns a nullable string
  static String? validateName(String? name) {
    if (name == null || name.isEmpty) {
      return ValidatorStrings.emptyFullNameField;
    }

    if (!_validateName(name)) {
      return ValidatorStrings.invalidFullNameField;
    }
    return null;
  }
  ...
  //A function that validates Password  and returns a nullable string
  static String? validatePassword(String? password) {
    if (password == null || password.isEmpty) {
      return ValidatorStrings.emptyFullPasswordField;
    }

    if (!_validatePassword(password)) {
      return ValidatorStrings.invalidPasswordIDField;
    }
    return null;
  }
